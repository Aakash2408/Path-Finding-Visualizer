...
class FirestoreIndexes {
    deploy(options, indexes, fieldOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingIndexes = yield this.listIndexes(options.project);
            const existingFieldOverrides = yield this.listFieldOverrides(options.project);
            ...
            if (indexesToDelete.length > 0) {
                ...
                if (!shouldDeleteIndexes) {
                    shouldDeleteIndexes = yield prompt_1.promptOnce({
                        type: "confirm",
                        name: "confirm",
                        default: false,
            ...
            for (const index of indexesToDeploy) {
                ...
                if (exists) {
                    ...
                    yield this.createIndex(options.project, index);
                }
            }
            ...
            if (fieldOverridesToDelete.length > 0) {
                ...
                if (!shouldDeleteFields) {
                    shouldDeleteFields = yield prompt_1.promptOnce({
                        type: "confirm",
                        name: "confirm",
                        default: false,
            ...
            for (const field of fieldOverridesToDeploy) {
                ...
                if (exists) {
                    ...
                    yield this.patchField(options.project, field);
                }
            }
    ...
    listIndexes(project) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield api.request("GET", `/v1/${url}`, {
                auth: true,
    ...
    patchField(project, spec) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield api.request("PATCH", `/v1/${url}`, {
                auth: true,
                origin: api.firestoreOrigin,
                data,
            });
